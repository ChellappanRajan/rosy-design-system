...
<section class="roboto-regular">
  <header class="header">
    ...
    <rosy-shimmer-loader shape="rounded-full" style="--width:40px;--height: 40px;"></rosy-shimmer-loader>
    <rosy-shimmer-loader shape="rounded-full" style="--width:40px;--height: 40px;"></rosy-shimmer-loader>
    <span>Rosy Tv</span>
    </div>
  </header>
  ...
  <div style="margin-top:2rem;display: flex;gap:1rem;flex-direction:column;">
    <rosy-shimmer-loader shape="rounded-full" style="--width:80px;--height: 30px;"></rosy-shimmer-loader>
    <rosy-shimmer-loader shape="rounded-full" style="--width:360px;--height: 30px;"></rosy-shimmer-loader>
    <rosy-shimmer-loader shape="rounded-full" style="--width:160px;--height: 30px;"></rosy-shimmer-loader>
  </div>
  <div class="card-wrapper">
    <rosy-shimmer-loader shape="rounded-full" style="--width:600px;--height: 30px;"></rosy-shimmer-loader>
    <div class="card-container">
    <rosy-shimmer-loader shape="rounded-md" class="card"></rosy-shimmer-loader>
    <rosy-shimmer-loader shape="rounded-md" class="card"></rosy-shimmer-loader>
    <rosy-shimmer-loader shape="rounded-md" class="card"></rosy-shimmer-loader>
    <rosy-shimmer-loader shape="rounded-md" class="card"></rosy-shimmer-loader>
    <rosy-shimmer-loader shape="rounded-md" class="card"></rosy-shimmer-loader>
  ...
  <div class="footer">
    <rosy-shimmer-loader shape="rounded-full" class="footer-card"></rosy-shimmer-loader>
    <rosy-shimmer-loader shape="rounded-full" class="footer-card"></rosy-shimmer-loader>
    <rosy-shimmer-loader shape="rounded-full" class="footer-card"></rosy-shimmer-loader>
    <rosy-shimmer-loader shape="rounded-full" class="footer-card"></rosy-shimmer-loader>
    <rosy-shimmer-loader shape="rounded-full" class="footer-card"></rosy-shimmer-loader>
